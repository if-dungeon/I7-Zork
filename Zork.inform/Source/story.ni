...
A room called Maze 15 is the room west from Cyclops Room.
...
A room called Cyclops Room is the room down from Treasure Room.
A room called Small Square Room is the room east from Treasure Room.
...
A room called East-West Passage is the room south from Deep Ravine.
A room called Chasm is the room east from Deep Ravine.
A room called Rocky Crawl is the room west from Deep Ravine.
...
A room called Deep Ravine is the room west from Rocky Crawl.
A room called Dome Room is the room east from Rocky Crawl.
...
A room called Stream View is the room west from Reservoir South.
...
A room called Reservoir North is the room north from Reservoir.
A room called Reservoir South is the room south from Reservoir.
A room called Stream is the room up from Reservoir.
Check going nowhere from Reservoir when going down: say "The dam blocks your way." instead.
...
A room called Atlantis Room is the room north from Reservoir North.
...
A room called Reservoir South is the room east from Stream View.
A room called Glacier Room is the room north from Stream View.
...
A room called Reservoir is the room down from Stream.
Check going nowhere from Stream when going up: say "The way is too narrow." instead.
...
A room called Glacier Room is the room up from Egyptian Room.
A room called Volcano View is the room south from Egyptian Room.
...
A room called Stream View is the room north from Glacier Room.
A room called Egyptian Room is the room east from Glacier Room.
...
A room called Lava Room is the room west from Ruby Room.
A room called Glacier Room is the room south from Ruby Room.
...
A room called Reservoir North is the room southeast from Atlantis Room.
A room called Cave is the room up from Atlantis Room.
...
A room called Dam is the room east from Deep Canyon.
A room called Round Room is the room south from Deep Canyon.
...
Section - Volcano near Wide Ledge
