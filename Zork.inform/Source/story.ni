...
Instead of going nowhere from a forest room when going up, say "There is no tree here suitable for climbing."
...
[ printed name	=	large tree
  nouns	=	tree
  adjectives	=	large
  flags	=	scenery, climbable?
  behaviour	=	-
]
